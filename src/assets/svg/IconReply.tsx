...
export function IconLinearReply({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
    >
      <g clip-path="url(#clip0_10214_56137)">
        <path
...
export function IconSolidReply({ className }: { className?: string }) {
  return (
    <svg
      className={cn(className, "text-icon")}
      xmlns="http://www.w3.org/2000/svg"
      ...
      fill="none"
    >
      <g clip-path="url(#clip0_10475_164392)">
        <path
          d="M17 11.6667C17 12.1382 16.8127 12.5903 16.4793 12.9237C16.1459 13.2571 15.6937 13.4444 15.2222 13.4444H4.55556L1 17V2.77778C1 2.30628 1.1873 1.8541 1.5207 1.5207C1.8541 1.1873 2.30628 1 2.77778 1H15.2222C15.6937 1 16.1459 1.1873 16.4793 1.5207C16.8127 1.8541 17 2.30628 17 2.77778V11.6667Z"
          fill="currentColor"
          stroke="currentColor"
      ...
      <defs>
        <clipPath id="clip0_10475_164392">
          <rect width="18" height="18" fill="currentColor" />
        </clipPath>
      </defs>
    </svg>
