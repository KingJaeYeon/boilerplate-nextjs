...
interface IFloatingOutlinedInputProps
...
export function FloatingOutlinedInput(props: IFloatingOutlinedInputProps) {
  ...
  return (
    <Col className={cn("relative isolate h-[56px] justify-center", className)}>
      <input
        id={id}
        ...
        className={
          "body3 m-[2px] flex h-[28px] flex-1 border-none bg-background px-[14px] py-[12px] focus-visible:outline-none"
        }
        {...rest}
      />
      <label
        htmlFor={id}
        className={cn(
          "body3 absolute left-2 bg-background px-2",
          isFocused
